...
export const ROUTES: RouteInfo[] = [
  ...
  },
  {
    ...
    submenu: [
      ...
      // { path: '/inputs/ClientDashboard/demand-supply-report', title: 'Demand Report', icon: 'ft-arrow-right submenu-icon', class: 'dropdown-item', isExternalLink: false, submenu: [] },
...
export const VCLIENTDASHBOARD: RouteInfo[] = [
