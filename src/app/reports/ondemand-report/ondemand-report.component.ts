...
@Component({
  selector: 'app-ondemand-report',
  templateUrl: './ondemand-report.component.html',
  styleUrls: ['./ondemand-report.component.scss']
})
export class OndemandReportComponent implements OnInit {
  ...
  onSubmit() {
    ...
    this.Apiservice.get('Reports/GetDemandList?workstream='+getMapsList.workstream+'&service='+getMapsList.service+'&batch='+getMapsList.batch+'&fromdate='+getMapsList.fromdate+'&todate='+getMapsList.todate).subscribe((data: any) => {
        console.log('Demand Report --->', data);
        this.globalConst.checkOriginAccess(data);
