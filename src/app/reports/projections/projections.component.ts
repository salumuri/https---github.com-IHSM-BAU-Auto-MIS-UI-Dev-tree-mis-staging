...
// import projectionsJson from '../projectionsJson.json';
...
export class ProjectionsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    var montsDt;
    this.Apiservice.get('Projections/GetProandRelizMonthsData?selYear=2023&pageType=Projections').subscribe((data: any) => {
  ...
  gettingProjectionDetails(montsDt){
    ...
    this.Apiservice.get('Projections/GetProjectionDetails?FromMonth='+fromdt+'&ToMonth='+todt+'&Year=2023').subscribe((data: any) => {
  ...
  insertProjection(){
    ...
    //return;
    this.Apiservice.postmethod('Projections/InsertMonthlyProjectons', postObj).subscribe((data:any)=>{
